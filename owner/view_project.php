                                                ...
                                                <table class="table table-hover">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><?php echo $res['total_expense'];?></td>
                                                            <td class="">
                                                     <a href="edit_project.php ?id=<?php echo $res['id']?>"><button type="button"
                                                                    class="btn btn-primary">Edit</button></a>
                                                            </td>
                                                            <td>
                                                                    <button type="button"
                                                                    onclick="deleteProject(<?php echo $res['id']?>)"
