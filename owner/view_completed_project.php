...
<body>
    ...
    $fetch1 = $fun->view_completed_project();
    ?>
            ...
            <div class="content-wrapper">
                <div class="row">
                    <div class="col-lg-12 grid-margin">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title"> Completed Project Details</h4>
                                                ...
                                                <table class="table table-hover">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><a href="update.php?status=true&id=<?php echo $res1['client_id'];?>"><button type="button"
                                                                    class="btn btn-primary">Not complate</button></td>
