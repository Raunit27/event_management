...
<body>
    ...
    $fetch1=$fun->view_manager_payment();
                                ...
                                ?>
                                            ...
                                            <form class="forms-sample" action="owner_form_sub.php" method="POST">
                                                ...
                                                <div class="form-group row mb-4">
                                                    <label for="manager" class=" col-sm-3 form-label">Manager:</label>
                                                    <div class="col-sm-6">
                                                ...
                                                <div class=text-center>
                                                    <button type="submit"
                                                        ...
                                                        class="btn btn-primary me-2" name="manager_pay">Pay</button>
                                                </div>
                                        </div>
                                        </form>
                                    </div>
                                            ...
                                            <table class="table table-hover">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><?php echo $res1['manager_name'];?></td>
