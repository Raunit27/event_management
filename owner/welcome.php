...
<body>
   ...
   $fetch1 = $fun->view_current_project();
   ?>
        <!-- partial -->
                                    ...
                                    <div class="card card-rounded">
                                        <div class="card-body">
                                            <div class="d-sm-flex justify-content-between align-items-start">
                                                <div>
                                                    <h4 class="card-title card-title-dash">Calendar</h4>
                                                    <p class="card-subtitle card-subtitle-dash">Stay update</p>
                                                    <div>
                                ...
                                <div class="col-12 grid-margin stretch-card">
                                    <div class="card card-rounded">
                                        <div class="card-body">
                                            <div class="d-sm-flex justify-content-between align-items-start">
                                                <div>
                                                    <h4 class="card-title card-title-dash">Current project</h4>
                                                    <p class="card-subtitle card-subtitle-dash">Ongoing project</p>
                                                </div>
                                                <!-- <div>
                                                ...
                                                <table class="table table-hover">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><?php echo $res1['manager'];?></td>
                                                            <!-- <td><?php echo $res1['total_cost'];?></td>
                                                            <td><?php echo $res1['total_expense'];?></td> -->
                                                            <!-- <td class="">
                                                     <a href="edit_project.php ?id=<?php echo $res1['id']?>"><button type="button"
                                                                    class="btn btn-primary">Edit</button></a>
                                                            </td>
                                                            <td>
                                                                    <button type="button"
                                                                    onclick="deleteProject(<?php echo $res1['id']?>)"
                                            ...
                                            <div class="row">
                                                <div class="col-lg-12">
                                                    <div class="d-flex justify-content-between align-items-center mb-3">
                                                        <div>
                                                            <h4 class="card-title card-title-dash">Your Managers</h4>
                                                        </div>
                                                    </div>
                                                    <div class="mt-3">
                                                        ...
                                                        <div
                                                            ...
                                                            <div class="d-flex">
                                                                <img class="img-sm rounded-10"
                                                                    src="images/managers_images/<?php echo $res['image'];?>" width="80" alt="profile">
                                                                <div class="wrapper ms-3">
                                                                    <p class="ms-1 mb-1 fw-bold"><?php echo $res['name'];?></p>
