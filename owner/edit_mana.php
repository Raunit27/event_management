            ...
            <div class="content-wrapper">
                <div class="row">
                    <div class="col-lg-12 grid-margin">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Edit Manager Details</h4>
                                <?php 
                                    if(isset($_GET["msg"])){
                                ?>
                                ...
                                <div class="col-md-10 grid-margin stretch-card container">
                                    <div class="card">
                                        <div class="card-body">
                                            <h4 class="card-title">Update manager information</h4>
                        ...
                        ?>
                                            <form class="forms-sample" action=" ./owner_form_sub.php" enctype="multipart/form-data" method="POST">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input type="text" name="m_nuber" class="form-control"
                                                            id="exampleInputMobile"value="<?php echo $res['number']; ?>">
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input type="date" name="doj" class="form-control"
                                                            id="exampleInputDOJ" value="<?php echo $res['doj']; ?>">
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    <label for="image" class="col-sm-3 col-form-label">Profile upload</label>
                                                    <div class="col-sm-9">
                                                ...
                                                <button type="submit" class="btn btn-primary me-2"
                                                    name="update_manager">Submit</button>
